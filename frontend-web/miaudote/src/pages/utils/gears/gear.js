        ...
        <div class="gears">
            <Grid item container justify="center" alignItems="center" direction="row">
                <Grid item xs={3} style={{marginTop: 100}}>
                    <SettingsIcon alt="gear" className="big" style={{color: theme.palette.secondary.main}}/>
                    <SettingsIcon alt="gear" className="small" style={{color: theme.palette.secondary.main}}/>
