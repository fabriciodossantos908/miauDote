...
const dogs = [Cachorro, Cachorro2, Cachorro3, Cachorro, Cachorro2, Cachorro3, Cachorro, Cachorro3, Cachorro]
...
export default function PetTab() {
    ...
    return (
        <Grid container spacing={3} justify="space-between" style={{ marginBottom: 20 }}>
