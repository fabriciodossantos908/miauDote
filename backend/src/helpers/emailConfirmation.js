module.exports = {
   emailConfirmation(emailDestinatario) {
      ...
      const html = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <title>Novo modelo de e-mail 2020-05-19</title> 
            <!--[if (mso 16)]>
               <style type="text/css">
            ...
            td .es-button-border:hover a.es-button-1 {
               background:#33e1e4!important;
               border-color:#33e1e4!important;
            }
            ...
            <div class="es-wrapper-color" style="background-color:#F6F6F6;"> 
               ...
               <tr style="border-collapse:collapse;"> 
                  ...
                  <table cellpadding="0" cellspacing="0" class="es-header" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top;"> 
                     <tr style="border-collapse:collapse;"> 
                     <td align="center" style="padding:0;Margin:0;background-image:url(https://hfdewi.stripocdn.email/content/guids/91d143f2-d7b5-4a1e-910a-dcff309ba358/images/16721589886520577.jpg);background-color:transparent;background-position:center bottom;background-repeat:no-repeat;" bgcolor="transparent" background="https://hfdewi.stripocdn.email/content/guids/91d143f2-d7b5-4a1e-910a-dcff309ba358/images/16721589886520577.jpg"> 
                        ...
                        <td align="left" style="Margin:0;padding-bottom:15px;padding-top:30px;padding-left:30px;padding-right:30px;border-radius:10px 10px 0px 0px;background-color:#FFFFFF;" bgcolor="#ffffff"> 
                           ...
                           <tr style="border-collapse:collapse;"> 
                              ...
                              <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left bottom;" role="presentation"> 
                                 <tr style="border-collapse:collapse;"> 
                                 <td align="center" style="padding:0;Margin:0;"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#212121;">Obrigado por utilizar nosso app!</h1></td> 
                                 </tr> 
                                 <tr style="border-collapse:collapse;"> 
                                 <td align="center" style="padding:10px;Margin:0;"><span class="es-button-border es-button-border-2" style="border-style:solid;border-color:#2CB543;background:#1BC7CB;border-width:0px;display:inline-block;border-radius:3px;width:auto;"><a href='http://ec2-107-22-51-247.compute-1.amazonaws.com:3000/usuarios/confirmar/${emailDestinatario}' class="es-button es-button-1" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;color:#FFFFFF;border-style:solid;border-color:#1BC7CB;border-width:10px 20px 10px 20px;display:inline-block;background:#1BC7CB;border-radius:3px;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;">Confirmar E-mail</a></span></td> 
                                 </tr> 
                              </table></td> 
                           </tr> 
                           </table></td> 
